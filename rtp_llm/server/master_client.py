...
class MasterClient:
    def __init__(self, host_service=None):
        frontend_server_count = StaticConfig.server_config.frontend_server_count
        self.max_connect_pool_size = StaticConfig.master_config.master_max_connect_pool_size // max(frontend_server_count, 1)
        self._session = None
