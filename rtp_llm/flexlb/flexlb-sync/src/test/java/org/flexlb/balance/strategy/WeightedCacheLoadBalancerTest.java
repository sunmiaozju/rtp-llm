...
class WeightedCacheLoadBalancerTest {
  ...
  void should_handle_empty_worker_map_when_no_workers_available() {
    ...
    WeightedCacheLoadBalancer weightedCacheLoadBalancer =
        new WeightedCacheLoadBalancer(systemEnvConfigService, engineWorkerStatus);
  ...
  void should_use_uniform_distribution_when_all_cache_usages_are_equal() {
    ...
    Map<String, WorkerStatus> decodeMap =
        EngineWorkerStatus.MODEL_ROLE_WORKER_STATUS_MAP.get("test-model").getDecodeStatusMap();
  ...
  void should_handle_group_selection_when_group_parameter_provided() {
    ...
    ModelWorkerStatus modelStatus =
        EngineWorkerStatus.MODEL_ROLE_WORKER_STATUS_MAP.get("test-model");
    ...
    ServerStatus status =
        weightedCacheLoadBalancer.select(balanceContext, RoleType.DECODE, "group-a");
