...
class ServiceRouteTest {
  ...
  void testConfigLoader() throws Exception {
    ...
    Assertions.assertEquals(
        "ea119_PPU_ZW810E_16TP_decode64", serviceRoute.getRoleEndpoints().getFirst().getGroup());
    ...
    Assertions.assertEquals(
        prefillEndpoint, serviceRoute.getRoleEndpoints().getFirst().getPrefillEndpoint());
    ...
    Assertions.assertEquals(
        decodeEndpoint, serviceRoute.getRoleEndpoints().getFirst().getDecodeEndpoint());
  }
