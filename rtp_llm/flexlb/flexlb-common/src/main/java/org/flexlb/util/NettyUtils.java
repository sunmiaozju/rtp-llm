...
public class NettyUtils {
  ...
  public static <T> String readBody(HttpNettyChannelContext<T> nettyCtx) {
    ...
    Optional.ofNullable(nettyCtx.getRequestCtx())
        .ifPresent(c -> c.setResBufferLength(mergedData.length));
  ...
  public static <T> void finishNettyWithException(
      HttpNettyChannelContext<T> nettyCtx, Throwable e) {
    finish(nettyCtx);
