...
/**
 * No-operation implementation of FlexMonitor interface. All methods are no-ops and return safe
 * default values.
 */
public class NoOpFlexMonitor implements FlexMonitor {
  ...
  public void register(
      String metricName, FlexMetricType metricType, FlexPriorityType priorityType) {}
